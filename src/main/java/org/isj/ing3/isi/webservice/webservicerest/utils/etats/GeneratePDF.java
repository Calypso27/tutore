...
public class GeneratePDF {
    ...
    public File genererCartesEtudiants(String fil, String speci, int an, int niv) throws Exception {
        ...
        try {
            ...
            String fileName;
            //fileName = "src/main/resources/etatsImprimes"+FileSystems.getDefault().getSeparator()+"carteEtudiants"+FileSystems.getDefault().getSeparator()+"cartes-" + fil + "-" + speci + "-" + System.currentTimeMillis() + ".pdf";
            fileName = (GeneratePDF.class.getClassLoader().getResource(".").getPath() + "etatsImprimes" + FileSystems.getDefault().getSeparator() + "carteEtudiants" + FileSystems.getDefault().getSeparator() + "cartes-" + fil + "-" + speci + "-" + System.currentTimeMillis() + ".pdf");
...
//jasperPrint.
                ...
                if (matricules.size() == 1)
                    //fileName=new File("/etatsImprimes"+FileSystems.getDefault().getSeparator()+"releves"+FileSystems.getDefault().getSeparator()+"Releve-" + matricule + "-" + classe + "-" + System.currentTimeMillis() + ".pdf").getAbsolutePath();
                    fileName = (GeneratePDF.class.getClassLoader().getResource(".").getPath() + "etatsImprimes" + FileSystems.getDefault().getSeparator() + "PVSyntheses" + FileSystems.getDefault().getSeparator() + "PVSynthese-" + "-" + classe + "-" + System.currentTimeMillis() + ".pdf");
                else
                    fileName = (GeneratePDF.class.getClassLoader().getResource(".").getPath() + "etatsImprimes" + FileSystems.getDefault().getSeparator() + "PVSyntheses" + FileSystems.getDefault().getSeparator() + "PVSyntheses" + "-" + classe + "-" + annee + "-" + System.currentTimeMillis() + ".pdf");
            ...
            if (imprimerAttestations) {
                ...
                if (notesAdmis.size() > 0) {
                    ...
                    byte[] attestations = genererAttestation(notesAdmis, classe, annee, dateJury,
                            speci, filiere, niveau, connection,etudiants, notesAdmis.get(0).getLibelle());
        ...
        if (matricules != null && matricules.size() > 0) {
            ...
            for (int i = 0; i < matricules.size(); i++) {
                ...
                try {
                    ...
                    if (matricules.size() == 1)
                        //fileName=new File("/etatsImprimes"+FileSystems.getDefault().getSeparator()+"releves"+FileSystems.getDefault().getSeparator()+"Releve-" + matricule + "-" + classe + "-" + System.currentTimeMillis() + ".pdf").getAbsolutePath();
                        fileName = (GeneratePDF.class.getClassLoader().getResource(".").getPath() + "etatsImprimes" + FileSystems.getDefault().getSeparator() + "certificats" + FileSystems.getDefault().getSeparator() + "Releve-" + matricule + "-" + classe + "-" + System.currentTimeMillis() + ".pdf");
                    else
                        fileName = (GeneratePDF.class.getClassLoader().getResource(".").getPath() + "etatsImprimes" + FileSystems.getDefault().getSeparator() + "certificats" + FileSystems.getDefault().getSeparator() + "Releves" + "-" + classe + "-" + annee + "-" + System.currentTimeMillis() + ".pdf");
                    System.out.println("fileName = " + fileName);
                    File f = new File(fileName);
                    f.createNewFile();
                    JasperExportManager.exportReportToPdfFile(jasperPrint, f.getAbsolutePath());
    ...
    public byte[] genererAttestation(List<Note> notes, String classe, int annee, String dateJury,
                                     String speci, String filiere, int niveau,
                                     Connection connection,Map<String, Etudiant> etudiants, String... mat) throws Exception {
            ...
            for (int i = 0; i < matricules.length; i++) {
                ...
                try {
                    ...
                    if (matricules.length == 1)
                        ...
                        fileName = (GeneratePDF.class.getClassLoader().getResource(".").getPath() + "etatsImprimes" + FileSystems.getDefault().getSeparator() + "attestations" + FileSystems.getDefault().getSeparator() + "attestation" + "-" + classe + "-" + annee + "-" + System.currentTimeMillis() + ".pdf");
                    File f = new File(fileName);
                    f.createNewFile();
                    JasperExportManager.exportReportToPdfFile(jasperPrint, f.getAbsolutePath());
                    if (i == 0) {
    ...
    public byte[] genererFicheAbsence(String libelleClasse, Integer niveau, String filiere, Integer
        ...
        try {
            ...
            String destination = (GeneratePDF.class.getClassLoader().getResource(".").getPath() + FileSystems.getDefault().getSeparator() + "etatsImprimes" + FileSystems.getDefault().getSeparator() + "absences" + FileSystems.getDefault().getSeparator() + "" + "Fiche " + filiere + "-" + niveau + "-" + semestre + "-" + System.currentTimeMillis() + ".pdf");
...
//            System.out.println(f.getAbsolutePath());
            ...
            f = new File(GeneratePDF.class.getClassLoader().getResource(".").getPath() + "etatsImprimes" + FileSystems.getDefault().getSeparator() + "pv" + FileSystems.getDefault().getSeparator() + "" + "PV-" + filiere + "-" + specialites + "-" + niveau + "-" + semestre + "-" + System.currentTimeMillis() + ".xlsx");
            f.createNewFile();
    ...
    private static File imprimerRecapitulatif(Integer niveau, String filiere, Integer annee_academique, String
        ...
        if (formatPDF) {
            // - Création du rapport au format PDF
            f = new File(GeneratePDF.class.getClassLoader().getResource(".").getPath() + "etatsImprimes" + FileSystems.getDefault().getSeparator() + "pv" + FileSystems.getDefault().getSeparator() + "" + "recapitulatif-" + filiere + "-" + niveau + "-" + semestre + "-" + System.currentTimeMillis() + ".pdf");
            f.createNewFile();
            JasperExportManager.exportReportToPdfFile(jasperPrint, f.getAbsolutePath());

        } else {
            f = new File(GeneratePDF.class.getClassLoader().getResource(".").getPath() + "etatsImprimes" + FileSystems.getDefault().getSeparator() + "pv" + FileSystems.getDefault().getSeparator() + "" + "recapitulatif-" + filiere + "-" + specialites + "-" + niveau + "-" + semestre + "-" + System.currentTimeMillis() + ".xlsx");
            f.createNewFile();
            SimpleXlsxReportConfiguration configuration = new SimpleXlsxReportConfiguration();
            configuration.setOnePagePerSheet(false);
            configuration.setIgnoreGraphics(false);
